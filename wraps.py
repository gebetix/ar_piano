...
class Contour(object):
    ...
    def get_defect(self, cnt):
        return cv2.matchShapes(self.contour, cnt.contour, cv2.CV_CONTOURS_MATCH_I2, -1)
...
class Image(object):
    ...
    def find_contours(self):
        a, contours, h = cv2.findContours(self.image, cv2.RETR_LIST, cv2.CHAIN_APPROX_NONE)
